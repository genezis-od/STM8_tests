...
/**
  ...
  *         This parameter can be any of the  @ref I2C_PECPosition_TypeDef
  *         enumeration.
  * @retval None
  */
...
/**
  ...
  *         This parameter can be any of the  @ref I2C_SMBusAlert_TypeDef
  *         enumeration.
  * @retval None
  */
...
void I2C_Send7bitAddress(I2C_TypeDef* I2Cx, uint8_t Address, I2C_Direction_TypeDef I2C_Direction)
{
  ...
  if (I2C_Direction != I2C_Direction_Transmitter)
  {
    ...
    Address <<= 1; // Need to 1 bit shift to left for 7-bit address!
