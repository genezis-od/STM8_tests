...
//void ClearSubSecond ( void );

unsigned char CheckAntiDrebezd (unsigned char *OldTime)
{
  unsigned char NowTime;
  NowTime = RTC->SSRL;
  (void) (RTC->DR3);
...
/*  GREEN_OFF;
  ClearSubSecond ();*/
//  static unsigned char OldTimeEXTI0;
//  if (CheckAntiDrebezd (&OldTimeEXTI0) != 0)
//  {
//    GREEN_TOGGLE;
//  }
    //GREEN_TOGGLE;
